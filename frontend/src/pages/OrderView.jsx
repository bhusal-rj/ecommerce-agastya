                    ...
                    {order ? order.products.map(product =>{
                        return (
                            ...
                            <div class="-m-px w-40 md:w-32">
                                <img class="hidden md:block" src="https://random.imagecdn.app/500/150" alt="girl-in-red-dress" />
                            </div>
                            <div class="flex justify-start md:justify-between items-start md:items-center flex-col md:flex-row w-full p-4 md:px-8">
                                <div class="flex flex-col md:flex-shrink-0 justify-start items-start">
                                    <h3 class="text-lg md:text-xl dark:text-white w-full font-semibold leading-6 md:leading-5 text-gray-800">{product.title}</h3>
                                    <div class="flex flex-row justify-start space-x-4 md:space-x-6 items-start mt-4">
                                    <p class="text-sm leading-none dark:text-gray-300 text-gray-600">Price: <span class="text-gray-800 dark:text-white"> {product.price}</span></p>
                                        <p class="text-sm leading-none dark:text-gray-300 text-gray-600">Quantity: <span class="text-gray-800 dark:text-white">{product.qty}</span></p>
                                    </div>
                                </div>
